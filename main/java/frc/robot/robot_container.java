...
public class robot_container {
  ...
  private void configureBindings() {
    ...
    left_bumper.whileTrue(new get_ball_from_low_level(elevator, ball_thing_subsystem));
    right_bumper.whileTrue(new put_ball_in_hole_thingy(elevator, ball_thing_subsystem));
    left_trigger.whileTrue(new get_ball_from_high_level(elevator, ball_thing_subsystem));
    right_trigger.whileTrue(new put_ball_in_net_thingy(elevator, ball_thing_subsystem));
